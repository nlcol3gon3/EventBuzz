<div class="container-fluid d-flex align-items-center justify-content-center py-5">
    <div class="card mt-5 w-50">
        <div class="card-body">
            <h1 class="card-title text-center mb-4 text-pink">User Login</h1>
    ...
    <?php endif; ?>
            ...
            <form action="/auth/user/login/action" method="post">
            ...
            <div class="text-center mt-3">
                <p>Don't have an account? <a href="/auth/user/register">Create one here</a></p>
            </div>
        </div>
    </div>
</div>
