<div class="container-fluid d-flex align-items-center justify-content-center py-5">
	<div class="card mt-5 w-50">
		<div class="card-body">
			<h1 class="card-title text-center mb-4 text-pink">User Registration</h1>
	...
	<?php endif; ?>
			...
			<form action="/auth/user/store" method="post">
			...
			<div class="text-center mt-3">
				<p>Already have an account? <a href="/auth/user/login">Login here</a></p>
			</div>
		</div>
	</div>
</div>
